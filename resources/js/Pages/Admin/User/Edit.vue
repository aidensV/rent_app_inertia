    ...
    <SectionMain>
      ...
      >
        ...
        >
          ...
          <FormField label="Enter Course" :class="{ 'text-red-400': form.errors.course }">
            <FormControl v-model="form.course" type="text" placeholder="course" :error="form.errors.course">
